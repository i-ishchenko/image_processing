...
figure, imshow(noisy2), title('Peppers noise');
...
noisyImgK_gaus = medfilt2(noisyImgGray);
figure, imshow(noisyImgK_gaus ), title('Noise filter median');
